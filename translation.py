...
"""
    ABOUT_TEXT = """
- **Bot :** `URL Uploader`
- **Creator :** [MHDMILHEM](https://telegram.me/MHDMILHEM)
- **Channel :** [VA](https://telegram.me/VaComp)
...
"""
    START_BUTTONS = InlineKeyboardMarkup(
        [[
        InlineKeyboardButton('Channel', url='https://telegram.me/VaComp'),
        InlineKeyboardButton('Feedback', url='https://telegram.me/VaComp')
        ],[
...
URL | newfilename | username | password"""
    DOWNLOAD_START = "<code>Downloading Please Wait...</code>"
    UPLOAD_START = "<code>Uploading ...</code>"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds. \n\nUploaded in {} seconds."
    RCHD_TG_API_LIMIT = "Downloaded in {} seconds.\nDetected File Size: {}\nSorry. But, I cannot upload files greater than 1.95GB due to Telegram API limitations."
    CUSTOM_CAPTION_UL_FILE = "<b>Join :-</b> @MHDMILHEM"
